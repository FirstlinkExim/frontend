...
import { setColor } from "@/redux/slices/productSlice";
...
const FilterSidebar = () => {
  ...
  const { category, size, color, price, type } = useAppSelector(FilterState);
  ...
  return (
    <div className="w-full lg:h-auto h-[450px] overflow-y-auto">
